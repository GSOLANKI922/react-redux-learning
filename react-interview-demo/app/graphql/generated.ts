...
export type EmailPasswordLogInMutation = { __typename?: 'Mutation', emailPasswordLogIn?: { __typename?: 'EmailPasswordLogInResponse', message?: string | null, data?: { __typename?: 'EmailPasswordLogInResponseData', token?: string | null, refreshToken?: string | null, user?: { __typename?: 'User', id?: string | null, email?: string | null, profileImage?: string | null, name?: string | null, firstName?: string | null, lastName?: string | null } | null } | null } | null };


export const EmailPasswordLogInDocument = gql`
  ...
  emailPasswordLogIn(data: $data) {
    ...
    `;
export type EmailPasswordLogInMutationFn = Apollo.MutationFunction<EmailPasswordLogInMutation, EmailPasswordLogInMutationVariables>;

/**
 * __useEmailPasswordLogInMutation__
 *
 * To run a mutation, you first call `useEmailPasswordLogInMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useEmailPasswordLogInMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [emailPasswordLogInMutation, { data, loading, error }] = useEmailPasswordLogInMutation({
 *   variables: {
 *      data: // value for 'data'
 *   },
 * });
 */
export function useEmailPasswordLogInMutation(baseOptions?: Apollo.MutationHookOptions<EmailPasswordLogInMutation, EmailPasswordLogInMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<EmailPasswordLogInMutation, EmailPasswordLogInMutationVariables>(EmailPasswordLogInDocument, options);
      }
export type EmailPasswordLogInMutationHookResult = ReturnType<typeof useEmailPasswordLogInMutation>;
export type EmailPasswordLogInMutationResult = Apollo.MutationResult<EmailPasswordLogInMutation>;
export type EmailPasswordLogInMutationOptions = Apollo.BaseMutationOptions<EmailPasswordLogInMutation, EmailPasswordLogInMutationVariables>;