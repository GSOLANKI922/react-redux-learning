...
export const CREATE_FAVORITE_MOVIE = gql`
  mutation CreateFavoriteMovie($data: favoriteMovieInput!) {
    createFavoriteMovie(data: $data) {
      message
    }
  }
`;
...
export const DELETE_FAVORITE_MOVIE = gql`
  mutation DeleteFavoriteMovie($deleteFavoriteMovieId: ID!) {
    deleteFavoriteMovie(id: $deleteFavoriteMovieId) {
      message
    }
  }
`;
